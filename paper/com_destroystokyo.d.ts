...
export class VanillaGoal<T> extends Goal<T> {
  ...
  static readonly ABSTRACT_SKELETON_MELEE: GoalKey<AbstractSkeleton>;
  ...
  static readonly VALIDATE_FLOWER: GoalKey<Bee>;
  static readonly VALIDATE_HIVE: GoalKey<Bee>;
  ...
  static readonly HOLD_GROUND_ATTACK: GoalKey<Illager>;
...
export class PlayerHandshakeEvent extends Event {
  ...
  */
   ...
   * be processed.
   *
   * @param cancel `true` if this event is cancelled, `false` otherwise
  */
  setCancelled(cancel: boolean): void;
  /**
