...
export class PhantomPreSpawnEvent extends PreCreatureSpawnEvent {
   ...
   * @return Entity
  */
  get spawningEntity(): Entity | null;
}
/**
...
export class EnderDragonFireballHitEvent extends EntityEvent {
  ...
  */
   ...
   * @return the targets
  */
  get targets(): Collection<LivingEntity> | null;
  /**
   * @return The area effect cloud spawned in this collision
  */
  get areaEffectCloud(): AreaEffectCloud;
...
export class TNTPrimeEvent extends BlockEvent {
  ...
  */
  setCancelled(cancel: boolean): void;
  get handlers(): HandlerList | null;
  static get handlerList(): HandlerList | null;
}
...
export class PaperServerListPingEvent extends ServerListPingEvent {
  ...
  */
  get playerSample(): PlayerProfile[];
  /**
...
export class ClassDefiner {
  ...
  */
  ...
  static get instance(): ClassDefiner;
}
...
export class PlayerArmorChangeEvent extends PlayerEvent {
  ...
  */
   ...
   * @return old item
  */
  get oldItem(): ItemStack | null;
  /**
   * Gets the new item that's replacing the old
   *
   * @return new item
  */
  get newItem(): ItemStack | null;
  toString(): string;
  get handlers(): HandlerList;
  static get handlerList(): HandlerList;
}
