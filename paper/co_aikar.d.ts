...
import { Iterable, Runnable, AutoCloseable, Class } from 'java.lang';
import { Identity } from 'net.kyori.adventure.identity';
...
export class Timings {
  ...
  */
  static set historyInterval(historyInterval: number);
  /**
  ...
  */
  static set historyLength(historyLength: number);
  /**
...
export class NullTimingHandler extends Timing {
  ...
  */
  startTiming(): Timing;
  /**
   * Stops timing and classs the data. Propagates the data up to group handlers.
   *
  ...
  */
   ...
   * @return TimingHandler
  */
  get timingHandler(): TimingHandler | null;
  close(): void;
}
/**
 * @deprecated Timings will be removed in the future
...
export class MRUMapCache<K, V> extends AbstractMap<K,V> {
   ...
   * @return Map
  */
  static of<K>(map: Map<K,V>): Map<K,V>;
}
/**
...
export class LoadingMap<K, V> extends AbstractMap<K,V> {
  ...
  */
   ...
   * @return Map
  */
  static of<K>(backingMap: Map<K,V>, loader: java_util_function_Function<K,V>): Map<K,V>;
  /**
  ...
  */
  static newAutoMap<K>(backingMap: Map<K,V>, keyClass: Class<K> | null, valueClass: Class<V>): Map<K,V>;
  /**
   * Creates a LoadingMap with an auto instantiating loader.
   *
   * Will auto construct class of of Value when not found
   ...
   * @return Map that auto instantiates on .get()
  */
  static newAutoMap<K>(backingMap: Map<K,V>, valueClass: Class<V>): Map<K,V>;
  /**
   * @see #newAutoMap
   *
   ...
   * @return Map that auto instantiates on .get()
  */
  static newHashAutoMap<K>(keyClass: Class<K> | null, valueClass: Class<V>): Map<K,V>;
  /**
   * @see #newAutoMap
   *
   * new Auto initializing map using a HashMap.
   ...
   * @return Map that auto instantiates on .get()
  */
  static newHashAutoMap<K>(valueClass: Class<V>): Map<K,V>;
  /**
   * @see #newAutoMap
   *
   * new Auto initializing map using a HashMap.
   ...
   * @return Map that auto instantiates on .get()
  */
  static newHashAutoMap<K>(keyClass: Class<K> | null, valueClass: Class<V>, initialCapacity: number, loadFactor: number): Map<K,V>;
  /**
   * @see #newAutoMap
   *
   * new Auto initializing map using a HashMap.
   ...
   * @return  Map that auto instantiates on .get()
  */
  static newHashAutoMap<K>(valueClass: Class<V>, initialCapacity: number, loadFactor: number): Map<K,V>;
  /**
   ...
   * @return Map
  */
  static newHashMap<K>(loader: java_util_function_Function<K,V>): Map<K,V>;
  /**
   * Initializes an auto loading map using a HashMap
   *
   * @param loader Loader to use
   ...
   * @return Map
  */
  static newHashMap<K>(loader: java_util_function_Function<K,V>, initialCapacity: number): Map<K,V>;
  /**
   * Initializes an auto loading map using a HashMap
   *
   * @param loader Loader to use
   ...
   * @return Map
  */
  static newHashMap<K>(loader: java_util_function_Function<K,V>, initialCapacity: number, loadFactor: number): Map<K,V>;
  /**
   ...
   * @return Map
  */
  static newIdentityHashMap<K>(loader: java_util_function_Function<K,V>): Map<K,V>;
  /**
   * Initializes an auto loading map using an Identity HashMap
   *
   * @param loader Loader to use
   ...
   * @return Map
  */
  static newIdentityHashMap<K>(loader: java_util_function_Function<K,V>, initialCapacity: number): Map<K,V>;
  size(): number;
  isEmpty(): boolean;
  containsKey(key: any | null): boolean;
  containsValue(value: any | null): boolean;
